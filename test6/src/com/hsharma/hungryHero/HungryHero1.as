...
package com.hsharma.hungryHero
{
	...
	public class HungryHero1 extends Sprite
	{
		...
		protected function onAddedToStage(event:Event):void
		{
			...
			Laya.stage.on(Event.RESIZE,this, stage_resize);
		}
		
		private function stage_resize(e:Event):void 
		{
			var scale:Number = Math.min(Laya.stage.width/GameConstants.stageWidth,Laya.stage.height/GameConstants.stageHeight);
			if (scale>1) {
				scale = 1;
			}
			//scaleX = scaleY = scale;
