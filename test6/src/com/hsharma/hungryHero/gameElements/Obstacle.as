	...
	public class Obstacle extends Sprite
	{
		...
		private function createObstacleArt():void
		{
			...
			if (_type == com.hsharma.hungryHero.GameConstants.OBSTACLE_TYPE_4)
			{
				...
				{
					obstacleAnimation = new StarlingMovieClip(("obstacle" + _type + "_0001"), null,10);
			...
			else
			{
				...
				obstacleImage.skin=Assets.getTexture("obstacle" + _type);
				//else
				//{
		...
		private function createObstacleCrashArt():void
		{
			...
			{
				// If this is the first time the object is being used.
				obstacleCrashImage = new Image(Assets.getTexture("obstacle" + _type + "_crash"));
		...
		private function createLookOutAnimation():void
		{
			...
			{
				// If this is the first time the object is being used.
				lookOutAnimation = new StarlingMovieClip(("watchOut_0001"),null, 10);
		...
		public function get hitArea2():Image { return _hitArea; }
