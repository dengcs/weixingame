...
package com.hsharma.hungryHero.objectPools
{
	...
	public class PoolParticle {
		...
		public function PoolParticle(caller:Object,create:Function, clean:Function = null, minSize:int = 50, maxSize:int = 200)
		{
			this.caller = caller;
			this.create = create;
			this.clean = clean;
		...
		{
			list[length++] = create.apply(caller);
			size++;
		}
		...
		{
			if(clean != null) clean.apply(caller,[item]);
			list[length++] = item;
		}
